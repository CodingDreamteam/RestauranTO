...
public class SystemConstants {
    ...
    public static final String _Search_Controller_Logger_Name = "search_controller";
    
    public static final String _Search_Controller_File_Log = "search_controller.log";
